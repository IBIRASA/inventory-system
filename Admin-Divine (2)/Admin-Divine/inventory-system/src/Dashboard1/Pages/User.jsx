        ...
        <tbody>
          {financeHistory.map((item, index) => (
            <tr key={index} className={index % 2 === 0 ? 'even-row' : 'odd-row'} >
              ...
              <td data-aos="zoom-in-down ">{item.Fullname}</td>
              <td data-aos="zoom-in-down">{item.Role}</td>
              <td data-aos="zoom-in-down">   <button className='bg-red-900 rounded-full py-2 px-8 text-gray-100 text-sm'>
                    Delete
                  </button></td>
